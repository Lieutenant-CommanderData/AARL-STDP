...
def STDPNetworkGenerator(presynaptic_neurons=None, postsynaptic_neurons=None, presynaptic_type=None, postsynaptic_type=None, synapse_type=None, voltage_monitor=False, pre_spike_monitor=False):
    ...
    if pre_spike_monitor:
        for presynaptic in pre_names:
            net.add_output(source=presynaptic, name=(presynaptic + ' Spikes'), spiking=True, color=output_color)
